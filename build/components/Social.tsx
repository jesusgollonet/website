...
export default function Social() {
  return (
    <>
      <section>
        <p>
          you can read more <Link href="/about">about me</Link>, maybe check out
          my <Link href="/diary">diary</Link>, where I share thoughts and
          ongoing projects. I&apos;m also around pretty much anywhere with the
          ...
          <Link href="https://bsky.app/@jesusgollonet.com">Bluesky</Link>,{" "}
